          ...
          <div className="d-flex">
            <div className={styles.headerTopLeft}>
              <p>
                ...
                <span className={styles.bookstoreHighlight}>BookStore</span>
              </p>
              {currentUser && currentUser.role > 0 && (
                <Link to="/admin" className={`ms-4 ${styles.navigateAdmin}`}>
                  Quản lý BookStore
                </Link>
              )}
            </div>
            <div className={styles.headerTopRight}>
              <p className={styles.hotline}>
                Hotline:{" "}
                <span className={styles.bookstoreHighlight}>123456789</span>
              </p>
              <p className="bookstore-email d-flex align-items-center">
                <IoMailOutline style={{ marginRight: 5 }} /> bookstore@email.com
              </p>
            </div>
          </div>
        </Container>
                ...
                {currentUser.email && currentUser.fullName ? (
                  <div className={styles.account}>
                    ...
                    <div className={styles.accountPopup}>
                      ...
                      <div className={styles.item}>
                        <Link className={styles.popupLink} to="/don-hang">
                          Đơn hàng
                        </Link>
                      </div>
                      <div className={styles.item}>
